        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className="flex space-x-5 sm:justify-center sm:mt-0">
            ...
            <a href={resume} target="_blank">
              <svg
                className="w-4 h-4 justify-center text-gray-500 hover:text-white transition-all duration-200 hover:cursor-pointer"
                aria-hidden="true"
            ...
            <a href="https://github.com/caseycapetola" target="_blank">
              <svg
                className="w-4 h-4 text-gray-500 hover:text-white transition-all duration-200 hover:cursor-pointer"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 24 24"
